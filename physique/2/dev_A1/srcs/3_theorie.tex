...
\begin{align}
    ...
    \end{cases} \label{eq:a_param} \\
    b &= \sqrt{\left(\frac{D}{2}\right)^2 - a^2} \label{eq:b_param}
\end{align}

avec :
\begin{itemize}
\item \(n\) : ordre de l'hyperbole (\(n = 0, 1, 2, \ldots\))
\item \(\lambda\) : longueur d'onde
\item \(D\) : distance entre les deux sources
