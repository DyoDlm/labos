...
raw = """
Freq [Hz]    Incertitude [Hz]    Amplitude [°]    Insertitude [°]    Phase [°]    Incertitude [°]
...
def fit_f0_from_phase(df):
    ...
    pars, cov = curve_fit(
        ...
        sigma=P_err, absolute_sigma=True, maxfev=200000
    )
...
print(f"phi0 = {phase_result['phi0']:.3f} ± {phase_result['sigma_phi0']:.3f} ")
