...
A partir de Ref. \cite{DMAprotocole}, nous pouvons decrire depuis les lois de Hook et de Newton la modelisation de notre systeme. L'instrument imporse une contrainte périodique en fonction du temps $\sigma$(t) de pusation $\omega$ et d'une contrainte de reference $\sigma_0$ tel que 
\begin{equation}
...
Selon les hypotheses du protocole (Ref. \cite{DMAprotocole} p. 2-3), les grandeurs viscoelastiques mesurees $E'$ (module de stockage) et $E''$ (module de perte) sont apres derivation de Eqs. \ref{eq:1} et \ref{eq:2}
\begin{equation}
