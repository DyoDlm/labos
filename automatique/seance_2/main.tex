...
\\\\
Par conséquent, les objectifs sont de faire le lien entre un comportement mesuré sur une installation réelle et une représentation par fonction de transfert et de comprendre et expliciter ce que l’on peut observer sur les représentations graphiques usuelles (Bode, Nyquist, Evans. (protocole)) 
\\\\
