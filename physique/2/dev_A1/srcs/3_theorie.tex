...
\subsection{Interferences et hyperboles}
...
avec \(n\) l'ordre de l'hyperbole (\(n = 0, 1, 2, \ldots\)), \(\lambda\) la longueur d'onde et \(D\) pour la distance entre les deux sources. Ainsi, les interférences entre deux sources d'ondes de surface forment alors des motifs hyperboliques qui reflétant en image (voir Fig. \ref{fig:intro}) la nature bidimensionnelle de leur propagation.
