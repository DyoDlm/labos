...
où \(A(r)\) est une fonction de Bessel tel que A(r) = $\frac{1}{\sqrt{r}}$ dépendant de la distance radiale \(r\). La célérité \(c\) de ces ondes dépend de la profondeur \(d\) et de la longueur d'onde \(\lambda\). Cela implique donc que nous nous situons en un milieu dispersif :
...
\subsection{Interférences et hyperboles}
...
\begin{align}
    a &= \begin{cases}
    \frac{n\lambda}{2} & \text{pour les interférences constructives} \\
    \frac{(2n+1)\lambda}{4} & \text{pour les interférences destructives}
        \end{cases} \label{eq:a} \\
    b &= \sqrt{\left(\frac{D}{2}\right)^2 - a^2} \label{eq:b}
\end{align}

avec \(n\) l'ordre de l'hyperbole (\(n = 0, 1, 2, \ldots\)), \(\lambda\) la longueur d'onde et \(D\) pour la distance entre les deux sources. Ainsi, les interférences entre deux sources d'ondes de surface forment alors des motifs hyperboliques (voir Fig. \ref{fig:intro}). Ces derniers reflètent la nature bidimensionnelle de leur propagation.
